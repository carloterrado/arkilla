<div class="h-[calc(100vmax-10rem)] sm:h-[calc(100vmin-10rem)] grid text-white text-xs sm:text-base">
    <div class="m-auto p-4 rounded-md bg-slate-900/70 w-full max-w-[400px]">
        <form action="#" class="flex flex-col gap-4">
            <h2 class="text-center font-semibold">Login</h2>
            <input class="rounded-lg px-3 py-2 text-black" type="email" placeholder="Enter your email">
            <input class="rounded-lg px-3 py-2 text-black" type="password" placeholder="Enter your password">
